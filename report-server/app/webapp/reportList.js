(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["reportList"],{
...
/***/ "./src/page/report/reportList.jsx":
/*!****************************************!*\
  !*** ./src/page/report/reportList.jsx ***!
  \****************************************/
/*! no static exports found */
...
var reportlist = function (_React$Component) {
    ...
    function reportlist(props) {
        ...
        var _this = _possibleConstructorReturn(this, (reportlist.__proto__ || Object.getPrototypeOf(reportlist)).call(this, props));
    ...
    _createClass(reportlist, [{
        ...
        value: function getAll() {
            ...
            var param = {};
            _HttpService2.default.post('reportServer/report/getAll', null).then(function (res) {
                if (res.resultCode == "1000") _this2.setState({ list: res.data });else _message3.default.error(res.message);
            });
        }
    }, {
        key: 'onNewQry',
        value: function onNewQry(e) {

            window.location.href = "../../reportCreate";
        }
    }, {
        ...
        value: function onDelButtonClick() {
            ...
            //   });
            if (confirm('确认删除吗？')) {
                _HttpService2.default.post('reportServer/report/getAll', JSON.stringify(this.state.selectedRows)).then(function (res) {
                    if (res.resultCode == "1000") {
                        _message3.default.success("删除成功！");
                        _this3.getAllQueryName();
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _card2.default,
                    { title: '\u62A5\u8868\u6A21\u677F', bodyStyle: { padding: "10px" } },
                    _react2.default.createElement(
                        _dropdown2.default,
                        { style: { marginRight: "20px" }, type: 'primary', overlay: _react2.default.createElement(
                                _menu2.default,
                                { onClick: function onClick(e) {
                                        return _this6.onNewQry(e);
                                    } },
                                _react2.default.createElement(
                                    _menu2.default.Item,
                                    { key: 'sql' },
                    ...
                    _react2.default.createElement(
                        _table2.default,
                        { dataSource: this.state.list, rowKey: "qry_id", rowSelection: rowSelection, ref: 'qryTable' },
