(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["SqlCreator"],{
...
var _reactSplitPane = __webpack_require__(/*! react-split-pane */ "./node_modules/_react-split-pane@0.1.92@react-split-pane/dist/index.esm.js");
...
var SqlCreator = function (_React$Component) {
    _inherits(SqlCreator, _React$Component);

    function SqlCreator(props) {
        _classCallCheck(this, SqlCreator);

        // alert(this.props.match.params.funcid);
        var _this = _possibleConstructorReturn(this, (SqlCreator.__proto__ || Object.getPrototypeOf(SqlCreator)).call(this, props));
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            'span',
                                            { style: { color: "black", fontWeight: "400", position: "absolute", bottom: "2px" } },
                                            _react2.default.createElement('span', { 'class': 'ant-form-item-required' }),
                                            '\u8F93\u5165\u67E5\u8BE2SQL'
                                        ),
                                        _react2.default.createElement(
                                            'span',
                                            ...
                                            _react2.default.createElement(
                                                _button2.default,
                                                { icon: _react2.default.createElement(_icons.ToolOutlined, null), loading: this.state.loading, onClick: function onClick() {
                                                        return _this8.onGenerateClick();
                                                    }, style: { marginRight: "10px" } },
                                                '\u751F\u6210\u67E5\u8BE2'
                                            ),
                                            _react2.default.createElement(
                                                _button2.default,
                                                { icon: _react2.default.createElement(_icons.BarsOutlined, null), onClick: function onClick() {
                                                        return _this8.sqlFormat();
                                                    }, style: { marginRight: "10px" } },
                                                ' \u683C\u5F0F\u5316'
                                            )
                                        )
                                    ),
                                    _react2.default.createElement(_reactCodemirror2.default, { ref: 'editorsql', value: '', style: { height: '600px', width: '450px', border: "2px solid red" }, options: options })
                                )
                            ),
                            _react2.default.createElement(
                                _col2.default,
...
exports.default = SqlCreator = _compatible.Form.create({})(SqlCreator);

/***/ })

}]);
//# sourceMappingURL=SqlCreator.js.map